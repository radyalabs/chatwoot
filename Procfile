...
worker_chat_delay: bundle exec sidekiq -C config/sidekiq.yml -c 3 -q chat_delay
worker: bundle exec rails ip_lookup:setup && bundle exec sidekiq -C config/sidekiq.yml -c 7
