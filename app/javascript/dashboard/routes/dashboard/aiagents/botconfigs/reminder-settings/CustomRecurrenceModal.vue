...
// Initialize end conditions from existing rule
if (props.rule) {
  // These would be passed through separate props in practice
  // For simplicity, check for _ends metadata
}
