...
const recurrenceLabel = computed(() => {
  return (
    ...
    t('AGENT_MGMT.SALESBOT.REMINDER.REPEAT_NONE')
  );
});
...
const sentCountText = computed(() => {
  ...
  if (count === 1) {
    return t('AGENT_MGMT.SALESBOT.REMINDER.SENT_COUNT_ONE', { count });
  }
  return t('AGENT_MGMT.SALESBOT.REMINDER.SENT_COUNT_OTHER', { count });
});
    ...
    >
      ...
      <div class="flex items-center gap-3 min-w-0 flex-1">
        ...
        <div class="min-w-0 flex-1">
          ...
          >
            {{ t('AGENT_MGMT.SALESBOT.REMINDER.NEXT_OCCURRENCE') }}:
      ...
      <div class="px-4 py-3 space-y-4">
          ...
          >
            <div class="flex items-center gap-2 mb-1">
              ...
              >
                {{
                  senderInbox?.name ||
                  t('AGENT_MGMT.SALESBOT.REMINDER.UNKNOWN_INBOX')
                }}
              </span>
            </div>
        ...
        >
          ...
          <span v-if="lastSentFormatted">
            {{ t('AGENT_MGMT.SALESBOT.REMINDER.LAST_SENT') }}:
            {{ lastSentFormatted }}
          </span>
        </div>
      </div>
