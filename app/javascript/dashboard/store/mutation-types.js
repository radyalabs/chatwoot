export default {
  ...
  UPDATE_CONVERSATION_CUSTOM_ATTRIBUTES:
    'UPDATE_CONVERSATION_CUSTOM_ATTRIBUTES',
  UPDATE_CONVERSATION_AI_SUMMARY: 'UPDATE_CONVERSATION_AI_SUMMARY',
  ...
  REMOVE_CONTACT_CUSTOM_ATTR_KEY: 'REMOVE_CONTACT_CUSTOM_ATTR_KEY',
  ...
  TOGGLE_AGENT_CONVERSATION_METRIC_LOADING:
    'TOGGLE_AGENT_CONVERSATION_METRIC_LOADING',
  SET_CREDIT_USAGE_METRIC: 'SET_CREDIT_USAGE_METRIC',
  TOGGLE_CREDIT_USAGE_METRIC_LOADING: 'TOGGLE_CREDIT_USAGE_METRIC_LOADING',
  ...
  // Billings
  SET_BILLING_MY_ACTIVE_SUBSCRIPTION: 'SET_BILLING_MY_ACTIVE_SUBSCRIPTION',
  SET_BILLING_LATEST_SUBSCRIPTION: 'SET_BILLING_LATEST_SUBSCRIPTION',
  SET_BILLING_SUBSCRIPTION_HISTORIES: 'SET_BILLING_SUBSCRIPTION_HISTORIES',

  // Agent Notification Settings
  SET_AGENT_NOTIFICATION_SETTINGS: 'SET_AGENT_NOTIFICATION_SETTINGS',
  SET_AGENT_NOTIFICATION_SETTINGS_UI_FLAG:
    'SET_AGENT_NOTIFICATION_SETTINGS_UI_FLAG',
  ADD_AGENT_NOTIFICATION_SETTING: 'ADD_AGENT_NOTIFICATION_SETTING',
  UPDATE_AGENT_NOTIFICATION_SETTING: 'UPDATE_AGENT_NOTIFICATION_SETTING',
  DELETE_AGENT_NOTIFICATION_SETTING: 'DELETE_AGENT_NOTIFICATION_SETTING',

  // Agent Skills
  SET_AGENT_SKILLS: 'SET_AGENT_SKILLS',
  SET_AGENT_SKILLS_UI_FLAG: 'SET_AGENT_SKILLS_UI_FLAG',
  ADD_AGENT_SKILL: 'ADD_AGENT_SKILL',
  UPDATE_AGENT_SKILL: 'UPDATE_AGENT_SKILL',
  DELETE_AGENT_SKILL: 'DELETE_AGENT_SKILL',

  // Scheduled Reminders
  SET_SCHEDULED_REMINDERS: 'SET_SCHEDULED_REMINDERS',
  SET_SCHEDULED_REMINDERS_UI_FLAG: 'SET_SCHEDULED_REMINDERS_UI_FLAG',
  ADD_SCHEDULED_REMINDER: 'ADD_SCHEDULED_REMINDER',
  UPDATE_SCHEDULED_REMINDER: 'UPDATE_SCHEDULED_REMINDER',
  DELETE_SCHEDULED_REMINDER: 'DELETE_SCHEDULED_REMINDER',
};
