Rails.application.routes.draw do
    ...
    namespace :v1 do
      ...
      resources :accounts, only: [:create, :show, :update] do
        ...
        scope module: :accounts do
          ...
          resources :contact_attribute_keys, only: [:index, :create, :destroy]
      ...
      resources :accounts, only: [:create] do
        scope module: :accounts do
          ...
          resources :ai_agents, only: [] do
            ...
            resources :skills, only: %i[index create update destroy], controller: 'agent_skills' do
              collection do
                get :custom_tools
              end
            end
  ...
  devise_scope :super_admin do
    ...
    namespace :super_admin do
      ...
      resources :custom_tools, only: [:index, :create, :show, :destroy]
    end
